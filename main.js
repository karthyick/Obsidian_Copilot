...
Output as a replace_all edit command to replace the document content.`,gA=`# COIN - Context-Observation-Insight-Next Steps Document Transformer
...
Keep EVERY piece of information from the original.
Output as a replace_all edit command to replace the document content.`,yA=`# DEVELOPER - Technical Documentation Transformer
...
Output as a replace_all edit command to replace the document content.`,SA=`# BUSINESS - Executive Business Communication Transformer
...
Quantify EVERYTHING possible.
Keep EVERY piece of information from the original.
Output as a replace_all edit command to replace the document content.`,EA=`# MANAGEMENT - Executive Briefing Transformer
...
Keep EVERY piece of information from the original.
Output as a replace_all edit command to replace the document content.`,TA=`# COSMOS - Knowledge Constellation Architect
...
Identify BLACK HOLES (knowledge gaps).
Output as a replace_all edit command to replace the document content.`,CA=`# CRINGE - Critical Review & Intelligent Negative Gauntlet Engine
...
DO NOT ask any questions - work with what's there.`;function Qd(n){if(n.size===0)return"";let e=[];return n.has("pyramid")&&e.push(fA),n.has("coin")&&e.push(gA),n.has("developer")&&e.push(yA),n.has("business")&&e.push(SA),n.has("management")&&e.push(EA),n.has("cosmos")&&e.push(TA),n.has("cringe")&&e.push(CA),`
